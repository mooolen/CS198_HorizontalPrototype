				...
				<form class="form-horizontal">	
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" placeholder="Required" class="span3" name="lName" id="lName" value="Smith" required /> 
							</div>	
						</div>	
						<div class="control-group">
							<label class="control-label" for="fName">First Name</label>
							<div class="controls">
								<input type="text" placeholder="Required" class="span3" name="fName" id="fName" value="John" required /> 
							</div>	
						</div>	
						<div class="control-group">
